          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                Join us in our mission to explore the UK sustainably, leaving a positive footprint behind.
                </p>
                <p className="flex items-center text-sm font-medium text-dark">
                  ...
                  <span>+256784180208</span>
                </p>
              </div>
            </div>

            <LinkGroup header="Resources">
              <NavLink link="/#" label="Maps" />
              <NavLink link="/#" label="Our Products" />
              <NavLink link="/#" label="UK Books" />
              <NavLink link="/#" label="Medicals" />
            </LinkGroup>
            <LinkGroup header="Company">
              <NavLink link="/#" label="Affialte" />
              <NavLink link="/#" label="Jobs" />
            ...
            <LinkGroup header="Quick Links">
              ...
              <NavLink link="/#" label="Destinations" />
            </LinkGroup>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base text-body-color">
                  {" "}
                  © {new Date().getFullYear()} EcoTravel{" "}
                </p>
              </div>
            </div>
          </div>
